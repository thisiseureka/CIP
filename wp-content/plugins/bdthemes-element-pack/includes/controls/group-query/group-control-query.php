    ...
    public function register_query_builder_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'       => __('This current query may not be display posts in the editor. Please save and refresh the page to see the posts.', 'bdthemes-element-pack'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options'   => [
					...
					'modified'      => __( 'Last Modified', 'bdthemes-element-pack' ),
