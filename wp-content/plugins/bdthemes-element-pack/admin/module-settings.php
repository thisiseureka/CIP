	...
	public static function get_widget_settings($callable) {
		...
		$settings_fields = [
			...
			'element_pack_other_settings'   => [
                ...
                [
					'name'              => 'ep_variation_swatches_shape',
					'label'             => esc_html__('Shape', 'bdthemes-element-pack'),
					'type'              => 'select',
                    'default'           => 'round',
                    'options'           => [
                        'round' => esc_html__('Default', 'bdthemes-element-pack'),
                ...
                [
					'name'              => 'ep_variation_swatches_tooltip',
					'label'             => esc_html__('Tooltip', 'bdthemes-element-pack'),
					'type'              => 'select',
                    'default'           => 'yes',
                    'options'           => [
                        'yes' => esc_html__('Default', 'bdthemes-element-pack'),
                        'no' => esc_html__('No', 'bdthemes-element-pack'),
                    ],
				],

                [
					'name'              => 'ep_variation_swatches_size',
