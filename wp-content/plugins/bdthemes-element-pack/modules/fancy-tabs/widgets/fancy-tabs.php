			...
			?>
				...
				<div id="<?php echo esc_attr($tab_id); ?>" <?php $this->print_render_attribute_string('tabs-content'); ?>>
					...
					<?php if ($item['tab_title'] && ('yes' == $settings['show_title'])) : ?>
						<<?php echo esc_attr(Utils::get_valid_html_tag($settings['title_tags'])); ?> <?php $this->print_render_attribute_string('fancy_title_tags'); ?>>
									...
									<span class="bdt-ep-fancy-tabs-icon">
										...
										<?php } elseif ($has_image and 'image' == $item['icon_type']) {
											if ($item['image']['id']) {
												...
												printf('<img src="%1$s" alt="%2$s">', esc_url($item['image']['url']), esc_html($item['tab_title']));
											}
										}
										?>
									</span>
