...
class Dynamic_Carousel extends Module_Base {
    ...
    public function get_style_depends() {
        if ( $this->ep_is_edit_mode() ) {
            ...
            return ['swiper', 'ep-font', 'ep-dynamic-carousel'];
        }
    }
    ...
    public function get_script_depends() {
        if ( $this->ep_is_edit_mode() ) {
            ...
            return ['swiper', 'ep-dynamic-carousel'];
        }
    }
    ...
    public function render() {
        ...
        if ( $settings['template_id'] !== '' ) {
            ...
            if ( empty($query->found_posts) ) {
                echo esc_html_x('Oops! There is no post found.', 'frontend', 'bdthemes-element-pack');
            } else {
                $this->render_header();
            ...
            echo '<div class="bdt-alert-warning" bdt-alert>' . esc_html_x('Oops!! There is no template selected, please select a template first.', 'Frontend', 'bdthemes-element-pack') . '<div>';
        }
    }
}
