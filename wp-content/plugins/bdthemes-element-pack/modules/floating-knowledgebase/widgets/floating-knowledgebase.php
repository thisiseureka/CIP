...
class Floating_Knowledgebase extends Module_Base {
    ...
    public function get_style_depends() {
        if ($this->ep_is_edit_mode()) {
            ...
            return ['ep-font', 'ep-floating-knowledgebase'];
        }
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'btn_icon',
            [
                'label' => esc_html__('Trigger Button Icon', 'bdthemes-element-pack') . BDTEP_NC,
        ...
        $this->add_control(
            'trigger_button_icon_color',
            [
                'label' => esc_html__('Icon Color', 'bdthemes-element-pack') . BDTEP_NC,
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdt-floating-knowledgebase .btn .bdt-icon-wrapper i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .bdt-floating-knowledgebase .btn .bdt-icon-wrapper svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'trigger_button_icon_size',
            [
                'label' => esc_html__('Icon Size', 'bdthemes-element-pack') . BDTEP_NC,
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', 'rem'],
                'selectors' => [
                    '{{WRAPPER}} .bdt-floating-knowledgebase .bdt-icon-wrapper' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'trigger_button_active_icon_color',
            [
                'label' => esc_html__('Icon Color', 'bdthemes-element-pack') . BDTEP_NC,
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .floating-help-center__btn.floating-help-center__popup--active .btn .bdt-icon-wrapper i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .floating-help-center__btn.floating-help-center__popup--active .btn .bdt-icon-wrapper svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        ?>
        <div <?php $this->print_render_attribute_string('floating-knowledgebase'); ?>>

            <div id="bdt-floating-help-center" class="floating-help-center">                

                <?php if ($settings['btn_icon']['value']): ?>
                <span class="bdt-icon-wrapper bdt-normal-icon bdt-hidden">
                    <?php Icons_Manager::render_icon($settings['btn_icon'], ['aria-hidden' => 'true', 'class' => 'fa-fw']); ?>
                </span>
                <?php endif; ?>

                <span class="bdt-icon-wrapper bdt-close-icon bdt-hidden">
                    <i class="ep-icon-close-2" aria-hidden="true"></i>
                </span>
