...
class Iframe extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				// translators: %s is the pipe character "|" wrapped in <code> tags to show the delimiter visually.
	...
	protected function render_device() {
		...
		$svg_url = esc_url(BDTEP_ASSETS_URL) . 'images/devices/' . $device_type . $rotation_state . '.svg';
