...
class Price_Table extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[ 
				'label'        => __( 'Overflow Hidden', 'bdthemes-element-pack' ),
		...
		$repeater->add_control(
			...
			[ 
				'label'       => __( 'Icon Hover Color', 'bdthemes-element-pack' ),
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [ 
		...
		$this->add_control(
			'features_hide_on',
			[ 
				'label'              => __( 'Features Hide On', 'bdthemes-element-pack' ),
		...
		$this->add_control(
			'read_more_toggle',
			[ 
				'label' => __( 'Read More Toggle', 'bdthemes-element-pack' ) . BDTEP_NC,
				'type'  => Controls_Manager::SWITCHER,
				'render_type' => 'template'
			]
		);
		$this->add_control(
			...
			[ 
				'label'     => __( 'Active Features Item', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 3,
				'condition' => [ 
		...
		$this->add_control(
			'show_all_features_text',
			[ 
				'label'     => __( 'Show All Features', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => __( '- Show all features', 'bdthemes-element-pack' ),
				'condition' => [ 
					'read_more_toggle' => 'yes',
				],
			]
		...
		$this->add_control(
			'less_features_text',
			[ 
				'label'     => __( 'Less Features', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => __( '- Less features', 'bdthemes-element-pack' ),
				'condition' => [ 
					'read_more_toggle' => 'yes',
				],
			]
		...
		$this->add_responsive_control(
			...
			[ 
				'label'      => __( 'List Padding', 'bdthemes-element-pack' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [ 
		...
		$this->add_responsive_control(
			'features_list_inner_margin',
			[ 
				'label'      => __( 'List Margin', 'bdthemes-element-pack' ) . BDTEP_NC,
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-price-table-features-list .bdt-price-table-feature-inner' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'list_striped',
			[ 
				'label'        => __( 'Striped', 'bdthemes-element-pack' ),
				'type'         => Controls_Manager::SWITCHER,
				'separator'    => 'before',
		...
		$this->start_controls_section(
			'section_style_feature_icon',
			[ 
				'label'     => __( 'Features Icon', 'bdthemes-element-pack' ) . BDTEP_NC,
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [ 
					'layout!' => '5',
				],
		...
		$this->start_controls_tabs( 'tabs_list_icon_style' );
		$this->start_controls_tab(
			'tab_list_icon_normal',
			[ 
				'label' => __( 'Normal', 'bdthemes-element-pack' ),
			]
		);
		$this->add_control(
			...
			[ 
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-price-table-feature-icon i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-price-table-feature-icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[ 
				...
				'selector' => '{{WRAPPER}} .bdt-price-table-feature-icon',
			]
		);
		$this->add_group_control(
			Group_Control_Border::get_type(),
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-price-table-feature-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-price-table-feature-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-price-table-feature-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-price-table-feature-icon' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[ 
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-price-table:hover .bdt-price-table-feature-icon i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-price-table:hover .bdt-price-table-feature-icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[ 
				...
				'selector' => '{{WRAPPER}} .bdt-price-table:hover .bdt-price-table-feature-icon',
			]
		);
		$this->add_control(
			'list_icon_hover_border_color',
			[ 
				'label'     => esc_html__( 'Border Color', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-price-table:hover .bdt-price-table-feature-icon' => 'border-color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'selectors' => [ 
					'{{WRAPPER}} .bdt-read-more-features' => 'text-align: {{VALUE}};',
				],
			]
		);

		$this->start_controls_tabs( 'tabs_read_more_toggle_style' );
		$this->start_controls_tab(
			'tab_read_more_toggle_normal',
			[ 
				'label' => __( 'Normal', 'bdthemes-element-pack' ),
			]
		);
		$this->add_control(
			'read_more_toggle_color',
			[ 
				'label'     => __( 'Color', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-read-more-features' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			Group_Control_Background::get_type(),
			[ 
				'name'     => 'read_more_toggle_bg_color',
				'selector' => '{{WRAPPER}} .bdt-read-more-features',
			]
		);
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[ 
				'name'     => 'read_more_toggle_border',
				'selector' => '{{WRAPPER}} .bdt-read-more-features',
				'separator' => 'before',
			]
		);
		$this->add_responsive_control(
			'read_more_toggle_border_radius',
			[ 
				'label'      => __( 'Border Radius', 'bdthemes-element-pack' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-read-more-features' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			'read_more_toggle_padding',
			[ 
				'label'      => __( 'Padding', 'bdthemes-element-pack' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-read-more-features' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			'read_more_toggle_margin',
			[ 
				'label'      => __( 'Margin', 'bdthemes-element-pack' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-read-more-features' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[ 
				'name'     => 'read_more_toggle_box_shadow',
				'selector' => '{{WRAPPER}} .bdt-read-more-features',
			]
		);
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[ 
				'name'     => 'read_more_toggle_typography',
				'selector' => '{{WRAPPER}} .bdt-read-more-features',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			'tab_read_more_toggle_hover',
			[ 
				'label' => __( 'Hover', 'bdthemes-element-pack' ),
			]
		);
		$this->add_control(
			'read_more_toggle_hover_color',
			[ 
				'label'     => __( 'Color', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-read-more-features:hover' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			Group_Control_Background::get_type(),
			[ 
				'name'     => 'read_more_toggle_hover_bg_color',
				'selector' => '{{WRAPPER}} .bdt-read-more-features:hover',
			]
		);
		$this->add_control(
			'read_more_toggle_hover_border_color',
			[ 
				'label'     => esc_html__( 'Border Color', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-read-more-features:hover' => 'border-color: {{VALUE}};',
				],
				'condition' => [ 
					'read_more_toggle_border_border!' => '',
				],
			]
		);
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[ 
				'name'     => 'read_more_toggle_hover_box_shadow',
				'selector' => '{{WRAPPER}} .bdt-read-more-features:hover',
			]
		);
		$this->end_controls_tab();
		...
		$this->start_controls_section(
			...
			[ 
				'label'     => __( 'Header & Pricing Wrap', 'bdthemes-element-pack' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [ 
					'layout' => '9',
				],
			...
			<ul class="bdt-price-table-features-list <?php echo esc_attr( $features_hide_on_setup ); ?>">
				<?php foreach ( $settings['features_list'] as $item ) :
					...
					if ( $item['tooltip_text'] ) {
						...
						$this->add_render_attribute( 'features', 'data-tippy-content', htmlspecialchars( $item['tooltip_text'], ENT_QUOTES, 'UTF-8' ), true );
					}
				...
				<?php endforeach; ?>
				<?php if ( ! empty( $settings['read_more_toggle'] ) ) : 
					$active_features_index = $settings['active_features_index'] - 1;
					?>
					<a href="javascript:void(0)" class="bdt-read-more-features bdt-more" data-bdt-default-load="<?php echo esc_attr($active_features_index); ?>" data-bdt-more="<?php echo esc_html($settings['show_all_features_text']); ?>" data-bdt-less="<?php echo esc_html($settings['less_features_text']); ?>"><?php echo esc_html($settings['show_all_features_text']); ?></a>
				<?php endif; ?>
			</ul>
		<?php endif;
	}
	...
	public function render_features_list_column() {
		...
		if ( ! empty( $settings['features_list'] ) ) : ?>
			<div>
				<ul class="bdt-price-table-features-list bdt-grid-collapse bdt-child-width-expand@m bdt-flex bdt-flex-middle  <?php echo esc_attr( $features_hide_on_setup ); ?>"
					data-bdt-grid>
					<?php foreach ( $settings['features_list'] as $item ) :
	...
	protected function render() {
		...
		?>
		<div <?php $this->print_render_attribute_string( 'table-wrap' ); ?>>
			<?php
