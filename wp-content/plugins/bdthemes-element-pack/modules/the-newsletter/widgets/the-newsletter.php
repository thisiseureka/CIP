                ...
                <form method="post">
                    ...
                    <?php if( $settings['firstname_show'] == 'yes' ){ ?>
                        <div class="tnp-field tnp-field-firstname">
                            <label for="tnp-name"><?php echo esc_html__('First name or full name', 'bdthemes-element-pack') ?></label>
                    ...
                    <?php if( $settings['lastname_show'] == 'yes' ){ ?>
                        <div class="tnp-field tnp-field-surname">
                            <label for="tnp-surname"><?php echo esc_html__('Last name', 'bdthemes-element-pack') ?></label>
                            <input class="tnp-surname" type="text" name="ns" value="">
                        </div>
                    <?php } ?>

                    <div class="tnp-field tnp-field-email">
                        <label for="tnp-email"><?php echo esc_html__('Email', 'bdthemes-element-pack') ?></label> 
