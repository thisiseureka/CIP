	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'default'   => 'center',
				'selectors' => [ 
					'{{WRAPPER}} .bdt-table table, {{WRAPPER}} .bdt-static-table .bdt-static-body-row-cell' => 'text-align: {{VALUE}}; justify-content: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'hide_entries_on_mobile',
			[ 
				'label'        => esc_html__( 'Hide Entries On Mobile', 'bdthemes-element-pack' ) . BDTEP_NC,
				'type'         => Controls_Manager::SWITCHER,
				'prefix_class' => 'bdt-hide-entries-on-mobile-',
				'default' => 'yes'
			]
		);
						...
						<th <?php $this->print_render_attribute_string( $column_repeater_key ); ?>>
							<div class="bdt-static-column-cell-wrap">
								...
								<div class="bdt-static-column-cell-text">
									<?php echo wp_kses_post( $column_cell['static_column_name'] ); ?>
								</div>
								...
								<td <?php $this->print_render_attribute_string( $row_span_repeater_key ); ?>>
									...
									<div class="bdt-static-body-row-cell-wrap">
										<div class="bdt-static-body-row-cell-text">
											<?php echo wp_kses_post( $static_table_cell[ $j ]['title'] ); ?>
										</div>
