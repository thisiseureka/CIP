...
class Bbpress_Single_Forum extends Module_Base {
		...
		<ul id="forums-list-<?php bbp_forum_id(); ?>" class="bbp-forums">
			...
			<li class="bbp-header">
				...
				<ul class="forum-titles">
					<li class="bbp-forum-info"><?php esc_html_e('Forum', 'bdthemes-element-pack'); ?></li>
					<li class="bbp-forum-topic-count"><?php esc_html_e('Topics', 'bdthemes-element-pack'); ?></li>
					<li class="bbp-forum-reply-count"><?php bbp_show_lead_topic() ? esc_html_e('Replies', 'bdthemes-element-pack') : esc_html_e('Posts', 'bdthemes-element-pack'); ?></li>
					<li class="bbp-forum-freshness"><?php esc_html_e('Last Post', 'bdthemes-element-pack'); ?></li>
				</ul>
	...
	protected function render_protected_form() { ?>
		<div id="bbpress-forums" class="bbpress-wrapper">
			<fieldset class="bbp-form" id="bbp-protected">
				<Legend><?php esc_html_e('Protected', 'bdthemes-element-pack'); ?></legend>
		...
		<form method="post" action="<?php bbp_wp_login_action(array('context' => 'login_post')); ?>" class="bbp-login-form">
			<fieldset class="bbp-form">
				...
				<div class="bbp-username">
					<label for="user_login"><?php esc_html_e('Username', 'bdthemes-element-pack'); ?>: </label>
				...
				<div class="bbp-password">
					<label for="user_pass"><?php esc_html_e('Password', 'bdthemes-element-pack'); ?>: </label>
				...
				<div class="bbp-remember-me">
					...
					<label for="rememberme"><?php esc_html_e('Keep me signed in', 'bdthemes-element-pack'); ?></label>
				</div>
			...
			<div class="bbp-alert-outer">
				<div class="bbp-alert-inner">
					...
					<p class="bbp-alert-actions">
						<a class="bbp-alert-back" href="<?php bbp_forum_permalink(bbp_get_topic_forum_id()); ?>"><?php esc_html_e('Leave', 'bdthemes-element-pack'); ?></a>
						<a class="bbp-alert-close" href="#"><?php esc_html_e('Stay', 'bdthemes-element-pack'); ?></a>
					</p>
				</div>
			</div>
	...
	protected function render_form_anonymous() {
		if (bbp_current_user_can_access_anonymous_user_form()) : ?>
			...
			<fieldset class="bbp-form">
				...
				<p>
					<label for="bbp_anonymous_author"><?php esc_html_e('Name (required):', 'bdthemes-element-pack'); ?></label><br />
				...
				<p>
					<label for="bbp_anonymous_email"><?php esc_html_e('Mail (will not be published) (required):', 'bdthemes-element-pack'); ?></label><br />
					<input type="text" id="bbp_anonymous_email" value="<?php bbp_author_email(); ?>" size="40" maxlength="100" name="bbp_anonymous_email" />
				</p>

				<p>
					<label for="bbp_anonymous_website"><?php esc_html_e('Website:', 'bdthemes-element-pack'); ?></label><br />
		...
		if (!bbp_is_single_forum()) : ?>
						...
						<fieldset class="bbp-form">
							<legend>
								...
								if (bbp_is_topic_edit()) :
									printf(esc_html__('Now Editing &ldquo;%s&rdquo;', 'bdthemes-element-pack'), bbp_get_topic_title());
								else : (bbp_is_single_forum() && bbp_get_forum_title())
										? printf(esc_html__('Create New Topic in &ldquo;%s&rdquo;', 'bdthemes-element-pack'), bbp_get_forum_title())
										: esc_html_e('Create New Topic', 'bdthemes-element-pack');
								endif; ?>
							</legend>
							...
							<?php if (!bbp_is_topic_edit() && bbp_is_forum_closed()) : ?>
								...
								<div class="bbp-template-notice">
									<ul>
										<li><?php esc_html_e('This forum is marked as closed to new topics, however your posting capabilities still allow you to create a topic.', 'bdthemes-element-pack'); ?></li>
									</ul>
								</div>
							...
							<div>
								...
								<p>
									<label for="bbp_topic_title"><?php printf(esc_html__('Topic Title (Maximum Length: %d):', 'bdthemes-element-pack'), bbp_get_title_max_length()); ?></label><br />
								...
								<?php if (!(bbp_use_wp_editor() || current_user_can('unfiltered_html'))) : ?>
									...
									<p class="form-allowed-tags">
										<label><?php printf(esc_html__('You may use these %s tags and attributes:', 'bdthemes-element-pack'), '<abbr title="HyperText Markup Language">HTML</abbr>'); ?></label><br />
								...
								<?php if (bbp_allow_topic_tags() && current_user_can('assign_topic_tags', bbp_get_topic_id())) : ?>
									...
									<p>
										<label for="bbp_topic_tags"><?php esc_html_e('Topic Tags:', 'bdthemes-element-pack'); ?></label><br />
								...
								<?php if (!bbp_is_single_forum()) : ?>
									...
									<p>
										<label for="bbp_forum_id"><?php esc_html_e('Forum:', 'bdthemes-element-pack'); ?></label><br />
										<?php
										bbp_dropdown(array(
											'show_none' => esc_html__('&mdash; No forum &mdash;', 'bdthemes-element-pack'),
								...
								<?php if (current_user_can('moderate', bbp_get_topic_id())) : ?>
									...
									<p>
										...
										<label for="bbp_stick_topic"><?php esc_html_e('Topic Type:', 'bdthemes-element-pack'); ?></label><br />
									...
									<p>
										...
										<label for="bbp_topic_status"><?php esc_html_e('Topic Status:', 'bdthemes-element-pack'); ?></label><br />
								...
								<?php if (bbp_is_subscriptions_active() && !bbp_is_anonymous() && (!bbp_is_topic_edit() || (bbp_is_topic_edit() && !bbp_is_topic_anonymous()))) : ?>
									...
									<p>
										...
										<?php if (bbp_is_topic_edit() && (bbp_get_topic_author_id() !== bbp_get_current_user_id())) : ?>
											...
											<label for="bbp_topic_subscription"><?php esc_html_e('Notify the author of follow-up replies via email', 'bdthemes-element-pack'); ?></label>

										<?php else : ?>

											<label for="bbp_topic_subscription"><?php esc_html_e('Notify me of follow-up replies via email', 'bdthemes-element-pack'); ?></label>
								...
								<?php if (bbp_allow_revisions() && bbp_is_topic_edit()) : ?>
									...
									<fieldset class="bbp-form">
										<legend>
											...
											<label for="bbp_log_topic_edit"><?php esc_html_e('Keep a log of this edit:', 'bdthemes-element-pack'); ?></label><br />
										</legend>

										<div>
											<label for="bbp_topic_edit_reason"><?php printf(esc_html__('Optional reason for editing:', 'bdthemes-element-pack'), bbp_get_current_user_name()); ?></label><br />
								...
								<div class="bbp-submit-wrapper">
									...
									<button type="submit" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit"><?php esc_html_e('Submit', 'bdthemes-element-pack'); ?></button>
			...
			<?php elseif (bbp_is_forum_closed()) : ?>
				...
				<div id="forum-closed-<?php bbp_forum_id(); ?>" class="bbp-forum-closed">
					<div class="bbp-template-notice">
						<ul>
							<li><?php printf(esc_html__('The forum &#8216;%s&#8217; is closed to new topics and replies.', 'bdthemes-element-pack'), bbp_get_forum_title()); ?></li>
						</ul>
					</div>
				</div>
					...
					<div class="bbp-template-notice">
						<ul>
							<li><?php is_user_logged_in()
									? esc_html_e('You cannot create new topics.', 'bdthemes-element-pack')
									: esc_html_e('You must be logged in to create new topics.', 'bdthemes-element-pack');
								?></li>
						</ul>
					</div>
	...
	<?php
		...
		<div id="forum-private" class="bbp-forum-content">
			<h1 class="entry-title"><?php esc_html_e('Private', 'bdthemes-element-pack'); ?></h1>
			<div class="entry-content">
				<div class="bbp-template-notice info">
					<ul>
						<li><?php esc_html_e('You do not have permission to view this forum.', 'bdthemes-element-pack'); ?></li>
					</ul>
				</div>
			</div>
		</div><!-- #forum-private -->
