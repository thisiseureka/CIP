...
namespace ElementPack\Modules\CryptoCurrencyGrid\Widgets;
...
class Crypto_Currency_Grid extends Module_Base {

	public function get_name() {
		return 'bdt-crypto-currency-grid';
	}

	public function get_title() {
		return BDTEP . esc_html__( 'Crypto Currency Grid', 'bdthemes-element-pack' );
	}

	public function get_icon() {
		return 'bdt-wi-crypto-currency-grid';
	}
	...
	public function get_style_depends() {
		if ( $this->ep_is_edit_mode() ) {
			...
			return [ 'ep-crypto-currency-grid' ];
		}
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'selectors'       => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid' => 'grid-template-columns: repeat({{SIZE}}, 1fr);',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'selectors' => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid' => 'grid-column-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'selectors' => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid' => 'grid-row-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[ 
				...
				'selector' => '{{WRAPPER}} .bdt-crypto-currency-grid-item',
			]
		);
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[ 
				...
				'selectors' => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-item:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[ 
				...
				'selector' => '{{WRAPPER}} .bdt-crypto-currency-grid-item:hover',
			]
		);
		...
		$this->add_group_control(
			...
			[ 
				...
				'selector' => '{{WRAPPER}} .bdt-crypto-currency-grid-img img',
			]
		);
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-img img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-img img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-img img' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'type'      => Controls_Manager::SLIDER,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-img img' => 'width: {{SIZE}}{{UNIT}}; min-width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[ 
				...
				'default'   => '',
				'selectors' => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-title h4' => 'color: {{VALUE}};',
				],
				'condition' => [ 
					'show_currency_name' => 'yes'
				]
		...
		$this->add_group_control(
			...
			[ 
				...
				'selector'  => '{{WRAPPER}} .bdt-crypto-currency-grid-title h4',
				'condition' => [ 
					'show_currency_name' => 'yes'
				]
			]
		...
		$this->add_control(
			...
			[ 
				...
				'default'   => '',
				'selectors' => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-title h4 span' => 'color: {{VALUE}};',
				],
				'condition' => [ 
					'show_currency_short_name' => 'yes'
				]
		...
		$this->add_group_control(
			...
			[ 
				...
				'selector'  => '{{WRAPPER}} .bdt-crypto-currency-grid-title h4 span',
				'condition' => [ 
					'show_currency_short_name' => 'yes'
				]
			]
		...
		$this->add_control(
			...
			[ 
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-price-nu' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[ 
				...
				'selector' => '{{WRAPPER}} .bdt-crypto-currency-grid-price-nu',
			]
		);
		...
		$this->add_control(
			...
			[ 
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-price-text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-crypto-currency-grid-price-text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[ 
				...
				'selector' => '{{WRAPPER}} .bdt-crypto-currency-grid-price-text',
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'crypto', [ 
			'class'         => 'bdt-crypto-currency-grid',
			'id'            => $id,
		...
		$this->add_render_attribute( 'crypto-item', 'class', 'bdt-crypto-currency-grid-item' );
		...
		<div <?php $this->print_render_attribute_string( 'crypto' ); ?>>
			...
			<div class="bdt-crypto-loader-wrap bdt-flex bdt-flex-center bdt-flex-middle bdt-padding-large">
				<img src="<?php echo esc_url( BDTEP_ASSETS_URL ); ?>images/loading.svg" alt="Bitcoin" class="bdt-ep-crypto-loader">
			</div>
