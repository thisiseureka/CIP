		...
		$this->add_control(
			...
			[
				...
				'options'    => [
					...
					'PT' => __('Portugal (Western Europe)', 'bdthemes-element-pack'),
					// EASTERN EUROPE
					...
					// UNITED KINGDOM
					'GB' => __('United Kingdom (Northern Europe)', 'bdthemes-element-pack'),
					'EN' => __('England (Northern Europe)', 'bdthemes-element-pack'),
					'SC' => __('Scotland (Northern Europe)', 'bdthemes-element-pack'),
					'WA' => __('Wales (Northern Europe)', 'bdthemes-element-pack'),
					'NI' => __('Northern Ireland (Northern Europe)', 'bdthemes-element-pack'),
					// SOUTHERN AMERICA
					...
					//spain
					'ES' => __('Spain', 'bdthemes-element-pack'),
				],
				'default'    => 'AU',
				'dynamic'    => ['active' => true],
				'condition' => [
