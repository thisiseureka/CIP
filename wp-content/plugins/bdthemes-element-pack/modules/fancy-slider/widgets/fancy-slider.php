...
class Fancy_Slider extends Module_Base {
	...
	public function get_style_depends() {
		if ( $this->ep_is_edit_mode() ) {
			...
			return [ 'swiper', 'ep-font', 'ep-fancy-slider' ];
		}
	}
	...
	public function get_script_depends() {
		if ( $this->ep_is_edit_mode() ) {
			...
			return [ 'swiper', 'imagesloaded', 'ep-fancy-slider' ];
		}
	}
	...
	public function render_header() {
		...
		?>
		<div <?php $this->print_render_attribute_string( 'fancy-slider' ); ?>>
	...
	protected function rendar_item_image( $content ) {
		...
		if ( ! $thumb_url ) {
			printf( '<img src="%1$s" alt="%2$s">', esc_url( $content['slide_image']['url'] ), esc_html( $content['title'] ) );
		} else {
					...
					<div class="bdt-ep-fancy-slider-content">
						...
						<?php if ( $content['title'] && ( 'yes' == $settings['show_title'] ) ) : ?>
							<<?php echo esc_attr( Utils::get_valid_html_tag( $settings['title_tags'] ) ); ?>
								<?php $this->print_render_attribute_string( 'fancy_title_tags' ); ?>>
	...
	protected function render() {
		...
		foreach ( $settings['slides'] as $index => $slide ) : ?>
						...
						<div
							class="swiper-slide bdt-ep-fancy-slider-item elementor-repeater-item-<?php echo esc_attr( $slide['_id'] ); ?>">
