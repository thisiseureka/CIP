...
class Threesixty_Product_Viewer extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'start_frame',
			[ 
				'label'     => __( 'Start Frame', 'bdthemes-element-pack' ),
		...
		$this->add_control(
			'end_frame',
			[ 
				'label'     => __( 'End Frame', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [ 
					'px' => [ 
						'min'  => 8,
		...
		$this->add_control(
			'frame_time',
			[ 
				'label'       => __( 'Frame Time', 'bdthemes-element-pack' ),
		...
		$this->add_control(
			'stop_frame',
			[ 
				'label'       => __( 'Stop Frame', 'bdthemes-element-pack' ),
		...
		// 	'frame',
		// 	[
		// 		'label'       => __('Frame', 'bdthemes-element-pack'),
	...
	protected function render() {
		...
		if ( ! empty( $image_urls ) ) {
			...
			?>
			<div <?php $this->print_render_attribute_string( 'threesixty' ); ?>>

				<div class="bdt-tspv-container"></div>

				<?php if ( $settings['full_screen_button'] ) : ?>
					<a <?php $this->print_render_attribute_string( 'tspv-fb' ); ?>>
						<i class="ep-icon-<?php echo esc_attr( $settings['tspv_fb_icon'] ); ?>" aria-hidden="true"></i>
					</a>
				<?php endif; ?>
			...
			<div class="bdt-alert-warning" bdt-alert>
				...
				<p>
					<?php printf( esc_html__( 'Please choose a set of images or set url.', 'bdthemes-element-pack' ) ); ?>
				</p>
			</div>
			<?php
		}
