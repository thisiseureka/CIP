	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'  => Controls_Manager::SWITCHER,
				'description'       => esc_html__('Click History is the list of web pages a user has visited recently of Table Of Content. This feature also responsible for Hash Generator.', 'bdthemes-element-pack'),
			]
		);
		...
		$this->add_control(
			'extend_page',
			[
				'label' => esc_html__('Extend Page', 'bdthemes-element-pack') . BDTEP_NC,
				'type'  => Controls_Manager::SWITCHER,
				//'default'  => 'yes',
				'description'       => __('If a user scrolls to the bottom of the page and the page is not tall enough to scroll to the last table of contents item, then the page height is increased', 'bdthemes-element-pack'),
			]
		);
...
?>
	...
	?>
		<div <?php $this->print_render_attribute_string('toc-regular'); ?>>
			<div>
				<?php $this->table_of_content_header(); ?>
				<?php $this->table_of_content(); ?>
			</div>
	...
	?>
		<div class="bdt-table-of-content" <?php $this->print_render_attribute_string('table-of-content'); ?>></div>
<?php
	}
}
