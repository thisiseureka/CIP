...
?>
        <div <?php $this->print_render_attribute_string('crypto'); ?>>
            <table id="<?php echo esc_attr($id); ?>-table" <?php $this->print_render_attribute_string('crypto-table'); ?>>
                <thead>
                    <tr class="bdt-crypto-header">
                        <th class="bdt-hash-head">#</th>
                        <th class="bdt-coin-head"><?php echo esc_html__('coin', 'bdthemes-element-pack');?></th>
                        <th class="bdt-price-head"><?php echo esc_html__('price', 'bdthemes-element-pack');?></th>
                        <th class="bdt-price-24h-pecentage"><?php echo esc_html__('Change', 'bdthemes-element-pack');?></th>
                        <th class="bdt-marketcap-head"><?php echo esc_html__('marketcap', 'bdthemes-element-pack');?></th>
                        <th class="bdt-volume-head"><?php echo esc_html__('Volume (24h)', 'bdthemes-element-pack');?></th>
                        <th class="bdt-chat-head"><?php echo esc_html__('Supply', 'bdthemes-element-pack');?></th>
                        <th class="bdt-last-24h-changes"><?php echo esc_html__('LAST 24H', 'bdthemes-element-pack');?></th>
                    </tr>
                </thead>
            </table>
        </div>
