...
class Post_Block_Modern extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'item_left_padding',
			[ 
				'label'      => __( 'Left Part Padding', 'bdthemes-element-pack' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [ 
		...
		$this->add_responsive_control(
			'wrap_padding',
			[ 
				'label'      => __( 'Right Part Wrap Padding', 'bdthemes-element-pack' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [ 
		...
		$this->add_responsive_control(
			'item_padding',
			[ 
				'label'      => __( 'Right Part Padding', 'bdthemes-element-pack' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [ 
	...
	public function render_excerpt() {
		...
		<div class="bdt-post-block-modern-excerpt">
			...
			if ( has_excerpt() ) {
				...
				echo wp_kses_post(element_pack_custom_excerpt( $this->get_settings_for_display( 'excerpt_length' ), $strip_shortcode, $ellipsis ));
			}
			?>
		</div>
		<?php
	...
	public function render() {
		...
		if ( $wp_query->have_posts() ) :
			...
			?>
			<div <?php $this->print_render_attribute_string( 'post-block-modern' ); ?>>
								...
								<div class="bdt-post-block-modern-desc bdt-position-bottom-center bdt-position-z-index bdt-width-2-3@m ">
									...
									<?php if ( 'yes' == $settings['title'] ) : ?>
										<<?php echo esc_attr( Utils::get_valid_html_tag( $settings['title_tags'] ) ); ?>
											<?php $this->print_render_attribute_string( 'bdt-post-block-modern-title' ); ?>>
											<a href="<?php echo esc_url( get_permalink() ); ?>" class="bdt-link-reset"
								...
								<div class="bdt-post-block-modern-desc">
									...
									<?php if ( 'yes' == $settings['show_read_more'] ) : ?>
										<a href="<?php echo esc_url( get_permalink() ); ?>"
											class="bdt-post-block-modern-read-more bdt-link-reset<?php echo esc_attr( $animation ); ?>">
