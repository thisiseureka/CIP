		...
		if (bbp_allow_search()) : ?>
			<div class="bbp-search-form">
				<form role="search" method="get" id="bbp-search-form">
					<div>
						<label class="screen-reader-text hidden" for="bbp_search"><?php esc_html_e('Search for:', 'bdthemes-element-pack'); ?></label>
						<input type="hidden" name="action" value="bbp-search-request" />
						<input type="text" value="<?php bbp_search_terms(); ?>" name="bbp_search" id="bbp_search" />
						<input class="button" type="submit" id="bbp_search_submit" value="<?php esc_attr_e('Search', 'bdthemes-element-pack'); ?>" />
					</div>
				</form>
			</div>
		<?php endif;
			...
			<li class="bbp-header">
				...
				<ul class="forum-titles">
					...
					<li class="bbp-forum-reply-count"><?php bbp_show_lead_topic()
															? esc_html_e('Replies', 'bdthemes-element-pack')
															: esc_html_e('Posts',   'bdthemes-element-pack');
														?></li>
		...
		<div id="bbpress-forums" class="bbpress-wrapper bdt-bbpress-forums">
			...
			<?php else : ?>
				<div class="bbp-template-notice">
					<ul>
						<li><?php esc_html_e('Oh, bother! No forums were found here.', 'bdthemes-element-pack'); ?></li>
					</ul>
				</div>
			<?php endif; ?>
