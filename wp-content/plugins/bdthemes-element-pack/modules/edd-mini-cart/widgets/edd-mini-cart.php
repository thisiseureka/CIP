...
?>
	...
	?>
		<div class="edd_shopping_cart_content">
			<p class="edd-cart-number-of-items" <?php echo wp_kses_post($display); ?>><?php esc_html_e('Number of items in cart', 'bdthemes-element-pack'); ?>: <span class="edd-cart-quantity"><?php echo esc_html($cart_quantity); ?></span></p>
			<ul class="edd-cart">
				<?php if ($cart_items) : ?>
