...
class News_Ticker extends Module_Base {
	...
	public function get_keywords() {
		return [ 'news', 'ticker', 'report', 'message', 'information', 'blog', 'post ticker' ];
	}
	...
	public function render_time() {
		...
		?>
					...
					<span class="bdt-news-ticker-time bdt-margin-small-right"
						title="<?php esc_html_e( 'Published on:', 'bdthemes-element-pack' ); ?> <?php echo wp_kses_post( get_the_date() ); ?> <?php echo wp_kses_post( get_the_time() ); ?>">
						<span class="bdt-text-uppercase">
							<?php echo esc_attr( $news_hour ); ?>
						</span>
						<span>:</span>
					</span>
