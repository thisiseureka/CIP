...
class Bbpress_Single_Topic extends Module_Base {
			...
			<div class="bbp-meta">
				...
				<?php if (bbp_is_single_user_replies()) : ?>
					<span class="bbp-header">
						<?php esc_html_e('in reply to: ', 'bdthemes-element-pack'); ?>
	...
	protected function render_form_reply() {
				...
				<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
					...
					<form id="new-post" name="new-post" method="post">
						...
						<fieldset class="bbp-form">
							...
							<legend><?php printf(esc_html__('Reply To: %s', 'bdthemes-element-pack'), (bbp_get_form_reply_to()) ? 
								/* translators: %1$s: Reply ID, %2$s: Topic title */
								sprintf(esc_html__('Reply #%1$s in %2$s', 'bdthemes-element-pack'), bbp_get_form_reply_to(), bbp_get_topic_title()) : bbp_get_topic_title()); ?></legend>
							...
							<div>
								...
								<?php if (!(bbp_use_wp_editor() || current_user_can('unfiltered_html'))) : ?>
									...
									<p class="form-allowed-tags">
										<label><?php esc_html_e('You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes:', 'bdthemes-element-pack'); ?></label><br />
								...
								<?php if (bbp_allow_topic_tags() && current_user_can('assign_topic_tags', bbp_get_topic_id())) : ?>
									...
									<p>
										<label for="bbp_topic_tags"><?php esc_html_e('Tags:', 'bdthemes-element-pack'); ?></label><br />
								...
								<?php if (bbp_is_reply_edit()) : ?>
									...
									<?php if (current_user_can('moderate', bbp_get_reply_id())) : ?>
										...
										<p class="form-reply-to">
											<label for="bbp_reply_to"><?php esc_html_e('Reply To:', 'bdthemes-element-pack'); ?></label><br />
										...
										<p>
											<label for="bbp_reply_status"><?php esc_html_e('Reply Status:', 'bdthemes-element-pack'); ?></label><br />
									...
									<?php if (bbp_allow_revisions()) : ?>
										...
										<fieldset class="bbp-form">
											<legend>
												...
												<label for="bbp_log_reply_edit"><?php esc_html_e('Keep a log of this edit:', 'bdthemes-element-pack'); ?></label><br />
											</legend>

											<div>
												<!-- translators: %s: Current user name -->
												<label for="bbp_reply_edit_reason"><?php printf(esc_html__('Optional reason for editing:', 'bdthemes-element-pack'), bbp_get_current_user_name()); ?></label><br />
		...
		<ul id="topic-<?php bbp_topic_id(); ?>-replies" class="forums bbp-replies">
			<li class="bbp-header">
				<div class="bbp-reply-author"><?php esc_html_e('Author', 'bdthemes-element-pack'); ?></div>
				<div class="bbp-reply-content"><?php bbp_show_lead_topic() ? esc_html_e('Replies', 'bdthemes-element-pack') : esc_html_e('Posts', 'bdthemes-element-pack'); ?></div>
			</li>
			<li class="bbp-body">
			...
			<li class="bbp-footer">
				<div class="bbp-reply-author"><?php esc_html_e('Author', 'bdthemes-element-pack'); ?></div>
				<div class="bbp-reply-content">
					<?php bbp_show_lead_topic() ? esc_html_e('Replies', 'bdthemes-element-pack') : esc_html_e('Posts', 'bdthemes-element-pack'); ?></div>
			</li>
		</ul>
	...
	<?php do_action('bbp_template_after_pagination_loop');
		...
		<ul id="bbp-topic-<?php bbp_topic_id(); ?>-lead" class="bbp-lead-topic">
			<li class="bbp-header">
				<div class="bbp-topic-author"><?php esc_html_e('Creator', 'bdthemes-element-pack'); ?></div><!-- .bbp-topic-author -->
				<div class="bbp-topic-content">
					<?php esc_html_e('Topic', 'bdthemes-element-pack'); ?>
			...
			<li class="bbp-footer">
				...
				<div class="bbp-topic-author"><?php esc_html_e('Creator', 'bdthemes-element-pack'); ?></div>
