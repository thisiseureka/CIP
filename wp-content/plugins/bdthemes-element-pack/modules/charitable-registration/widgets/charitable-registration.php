		...
		<form method="post" id="charitable-registration-form" class="charitable-form">
            <div class="charitable-form-fields cf">
                ...
                <div id="charitable_field_user_email" class="charitable-form-field charitable-form-field-email required-field odd">
                    ...
                    <?php echo esc_html__('Email', 'bdthemes-element-pack'); ?><abbr class="required" title="required">*</abbr></label>
                ...
                <div id="charitable_field_user_login" class="charitable-form-field charitable-form-field-text required-field even">
                    <label for="charitable_field_user_ragistration_element"><?php echo esc_html__('Username', 'bdthemes-element-pack'); ?><abbr class="required" title="required">*</abbr></label>
                ...
                <div id="charitable_field_user_pass" class="charitable-form-field charitable-form-field-password required-field odd">
                    <label for="charitable_field_user_pass_element"><?php echo esc_html__('Password', 'bdthemes-element-pack'); ?><abbr class="required" title="required">*</abbr></label>
            ...
            <div class="charitable-form-field charitable-submit-field">
                <button class="button charitable-button registration-button" type="submit" name="register"><?php echo esc_html__('Register', 'bdthemes-element-pack'); ?></button>
            </div>
