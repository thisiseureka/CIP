...
class WC_Products extends Module_Base {
	...
	public function get_keywords() {
		return [ 'product', 'woocommerce', 'table', 'wc', 'wc products' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => 'left',
				'selectors' => [
					'{{WRAPPER}} .bdt-wc-products .bdt-wc-product .bdt-badge' => '{{VALUE}}',
				],
					...
					<div <?php $this->print_render_attribute_string( 'wc-product' ); ?>>
						<div class="bdt-wc-product-inner">
							...
							<?php elseif ( $settings['show_badge'] and $product->is_on_sale() ) : ?>
								<div class="bdt-badge bdt-position-top-left bdt-position-small">
									<?php echo wp_kses_post(apply_filters('woocommerce_product_sale_flash', '<span class="bdt-onsale">' . esc_html__( 'Sale!', 'bdthemes-element-pack' ) . '</span>', $post, $product )); ?>
								</div>
							<?php endif; ?>
