		...
		<div class="bdt-post-slider-item">
			...
			<div class="bdt-post-slider-content bdt-padding-large bdt-background-muted">
	            ...
	            <?php if ($settings['show_tag']) : ?>
	        		...
	        		<?php if ($tags_list) : ?> 
	            		<div class="bdt-post-slider-tag-wrap" data-bdt-slider-parallax="x: 100, -100">
				...
				<?php if ($settings['show_meta']) : ?>
					<div class="bdt-post-slider-meta bdt-flex-inline bdt-flex-middle" data-bdt-slider-parallax="x: 200, -200">
