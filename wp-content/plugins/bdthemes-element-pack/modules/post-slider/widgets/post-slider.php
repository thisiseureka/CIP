...
class Post_Slider extends Module_Base {
	...
	public function register_controls() {
		...
		$this->add_control(
			'hide_on_tablet',
			[
				'label'   => esc_html__('Text Hide On Tablet', 'bdthemes-element-pack'),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition'   => [
					'show_text' => 'yes',
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .bdt-post-slider .bdt-post-slider-text p' => 'width: {{SIZE}}%;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-post-slider .bdt-post-slider-meta a:hover span' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'thumb_size',
			[
				'label' => esc_html__('Thumb Size', 'bdthemes-element-pack'),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max'  => 300,
...
?>
		<div <?php $this->print_render_attribute_string('slider-text'); ?> data-bdt-slideshow-parallax="x: 300,-300">
			<?php
			if (has_excerpt()) {
				the_excerpt();
			} else {
			...
			<div class="bdt-post-slider-content-wrap bdt-position-center bdt-position-z-index">
				<div class="bdt-post-slider-content">
					...
					if ($settings['show_meta']) : ?>
						<div class="bdt-post-slider-meta bdt-flex-inline bdt-flex-middle" data-bdt-slideshow-parallax="x: 320, -320">
