	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => sprintf(esc_html__('This feature will not work in the Firefox browser untill you enable browser compatibility so please %1$s look here %2$s', 'bdthemes-element-pack'), '<a href="https://developer.mozilla.org/en-US/docs/Web/CSS/backdrop-filter#Browser_compatibility" target="_blank">', '</a>'),
		...
		$this->add_control(
			...
			[
				...
				/* translators: %1$s is example value, %2$s and %3$s are HTML tags for a link */
				'description' => sprintf(esc_html__('For example: %1$s or Go %2$s this link %3$s and copy and paste the radius value.', 'bdthemes-element-pack'), '<b>75% 25% 43% 57% / 46% 29% 71% 54%</b>', '<a href="https://9elements.github.io/fancy-border-radius/" target="_blank">', '</a>'),
				'type'        => Controls_Manager::TEXT,
				'size_units'  => ['px', '%'],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-advanced-icon-box-icon-wrap' => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .bdt-ep-advanced-icon-box-icon-wrap img' => 'width: {{SIZE}}{{UNIT}};',
				],
				'conditions' => [
					'relation' => 'or',
					'terms'    => [
