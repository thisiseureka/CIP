...
?>
        ...
        <div class="bdt-honeycombs-area" <?php if ($settings['comb_animation_type'] !== '') { ?> bdt-grid bdt-scrollspy="cls: bdt-animation-<?php echo esc_attr($settings['comb_animation_type']); ?>; target: .bdt-comb-inner-wrapper; delay: <?php echo esc_attr( $settings['combs_anim_delay']['size'] ); ?>;" <?php } ?>>

            <div <?php $this->print_render_attribute_string('honeycombs'); ?>>
                ...
                <?php foreach ($settings['honeycombs_list'] as $index => $item) : ?>
                    ...
                    ?>
                    <a <?php $this->print_render_attribute_string('bdt-comb-link' . $index); ?>>
                        <div class="bdt-front-content">
                            ...
                            <?php if ($settings['title_display'] == 'yes') : ?>
                                <<?php echo esc_attr(Utils::get_valid_html_tag($titleTag)); ?> class="bdt-title">
                                    <?php echo wp_kses_post($item['honeycombs_title']); ?>
                                </<?php echo esc_attr(Utils::get_valid_html_tag($titleTag)); ?>>
                            <?php endif; ?>
                        </div>
