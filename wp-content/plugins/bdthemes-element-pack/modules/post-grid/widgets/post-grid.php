	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-post-grid .bdt-grid-custom' => 'margin-left: -{{SIZE}}{{UNIT}};',
					'(mobile){{WRAPPER}} .bdt-post-grid .bdt-grid-custom' => 'margin-left: -1px;',
					'{{WRAPPER}} .bdt-post-grid .bdt-grid-custom>*' => 'padding-left: {{SIZE}}{{UNIT}};',
					'(mobile){{WRAPPER}} .bdt-post-grid .bdt-grid-custom>*' => 'padding-left: 1px;',
					'{{WRAPPER}} .bdt-post-grid .bdt-grid+.bdt-grid-custom, {{WRAPPER}} .bdt-post-grid .bdt-grid-custom>.bdt-grid-margin' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'primary_item_hide',
			[ 
				'label'     => esc_html__( 'Primary Item Hide', 'bdthemes-element-pack' ),
		...
		$this->add_responsive_control(
			'secondary_columns',
			[ 
				'label'              => esc_html__( 'Secondary Columns', 'bdthemes-element-pack' ),
				'type'               => Controls_Manager::SELECT,
				'default'            => '3',
				'tablet_default'     => '3',
				'mobile_default'     => '1',
		...
		$this->add_responsive_control(
			...
			[ 
				'label'     => __( 'Secondary Alignment', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [ 
					'left'    => [ 
						'title' => __( 'Left', 'bdthemes-element-pack' ),
		...
		$this->add_control(
			...
			[ 
				'label'              => esc_html__( 'Ajax Load More', 'bdthemes-element-pack' ),
				'type'               => Controls_Manager::SWITCHER,
				'separator'          => 'before',
				'condition'          => [ 
					'show_pagination!' => 'yes',
		...
		$this->add_group_control(
			...
			[ 
				'name'     => 'image_border',
				'selector' => '{{WRAPPER}} .bdt-post-grid-img-wrap',
				'condition' => [ 
					'_skin' => [ 'bdt-harold', 'bdt-reverse', 'bdt-alter', 'bdt-alite' ],
				],
			]
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-post-grid-img-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [ 
					'_skin' => [ 'bdt-harold', 'bdt-reverse', 'bdt-alter', 'bdt-alite' ],
				],
		...
		$this->add_control(
			...
			[ 
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-post-grid-item:hover .bdt-post-grid-img-wrap' => 'border-color: {{VALUE}};',
				],
				'condition' => [ 
					'image_border_border!' => '',
					'_skin' => [ 'bdt-harold', 'bdt-reverse', 'bdt-alter', 'bdt-alite' ],
		...
		$this->add_responsive_control(
			'title_spacing',
			[ 
				'label'     => esc_html__( 'Primary Spacing', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [ 
					'size' => 5,
				],
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ep-pagination .bdt-pagination' => 'justify-content: {{VALUE}}',
                ],
            ]
        );
	...
	public function render_excerpt( $excerpt_length ) {
		...
		<div class="bdt-post-grid-excerpt">
			...
			if ( has_excerpt() ) {
				...
				echo wp_kses_post( element_pack_custom_excerpt( $excerpt_length, $strip_shortcode, $ellipsis ) );
			}
			?>
		</div>
