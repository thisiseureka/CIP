...
class WC_Carousel extends Module_Base {
	...
	public function get_keywords() {
		return ['carousel', 'woocommerce', 'wc', 'product', 'wc carousel', 'wc product', 'woocommerce carousel', 'woocommerce product'];
	}
	...
	public function get_style_depends() {
		if ($this->ep_is_edit_mode()) {
			...
			return ['swiper', 'ep-wc-carousel', 'ep-font'];
		}
	}

	public function get_script_depends() {
		if ($this->ep_is_edit_mode()) {
			return ['swiper', 'ep-woocommerce', 'ep-scripts'];
		} else {
			return ['swiper', 'ep-woocommerce'];
		}
	}
	...
	public function register_controls() {
		...
		$this->add_control(
			'show_cart_always',
			[
				'label'   => esc_html__('Show Cart always', 'bdthemes-element-pack'),
				'type'    => Controls_Manager::SWITCHER,
				'condition' => [
					'show_cart' => 'yes',
				]
		...
		$this->add_responsive_control(
			'badge_position',
			[
				'label'     => esc_html__('Choose Position', 'bdthemes-element-pack') . BDTEP_NC,
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'left'  => [
				...
				'default'   => 'left',
				'selectors' => [
					'{{WRAPPER}} .bdt-wc-carousel .bdt-badge' => '{{VALUE}}',
				],
		...
		// 		'type'      => Controls_Manager::COLOR,
		// 		'selectors' => [
		// 			'{{WRAPPER}} .bdt-wc-carousel .bdt-wc-carousel-title' => 'background-color: {{VALUE}};',
		// 			'{{WRAPPER}} .bdt-item-skin-hidie .bdt-products-skin-title a' => 'background-color: {{VALUE}};',
		// 		],
		// 	]
		// );
		...
		$this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdt-wc-carousel .bdt-wc-carousel-title a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .bdt-item-skin-hidie .bdt-products-skin-title a' => 'color: {{VALUE}};',
                ],
            ]
        );
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-wc-carousel .bdt-wc-carousel-title a:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-item-skin-hidie .bdt-products-skin-title a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'rem', '%'],
				'selectors'  => [
					'{{WRAPPER}} .bdt-wc-carousel .bdt-wc-carousel-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .bdt-item-skin-hidie .bdt-products-skin-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	public function render_header($skin = 'default') {
		...
		<div <?php $this->print_render_attribute_string('carousel'); ?>>
								...
								<div class="bdt-wc-carousel-item-inner">
									<?php if ($settings['show_badge'] and !$product->is_in_stock()) : ?>
										<div class="bdt-badge bdt-position-top-left bdt-position-small">
											<?php echo apply_filters('woocommerce_product_is_in_stock', '<span class="bdt-onsale">' . esc_html__('Out of Stock!', 'bdthemes-element-pack') . '</span>', $post, $product); ?>
										</div>
									<?php elseif ($settings['show_badge'] and $product->is_on_sale()) : ?>
										<div class="bdt-badge bdt-position-top-left bdt-position-small">
											<?php echo apply_filters('woocommerce_sale_flash', '<span class="bdt-onsale">' . esc_html__('Sale!', 'bdthemes-element-pack') . '</span>', $post, $product); ?>
										</div>
									<?php endif; ?>
									...
									<div class="bdt-wc-carousel-desc bdt-padding bdt-position-relative bdt-text-<?php echo esc_attr($text_align); ?>">
										<div class="bdt-wc-carousel-desc-inner">
											...
											<?php if ($settings['show_price'] or $settings['show_rating']) : ?>
												<div class="bdt-wc-carousel-price-wrapper bdt-flex-middle bdt-flex-<?php echo esc_attr($text_align); ?>">
			...
			<?php
						...
						echo '<div class="bdt-alert-warning" data-bdt-alert>' . esc_html_x('Ops! There is no product', 'Frontend', 'bdthemes-element-pack') . '<div>';
					}
				}
