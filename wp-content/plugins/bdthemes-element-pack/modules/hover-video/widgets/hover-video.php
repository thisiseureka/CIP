	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'selectors' => [ 
					'{{WRAPPER}} .bdt-hover-video.skin-accordion .bdt-hover-wrapper-list .bdt-hover-mask-list .bdt-hover-mask .bdt-hover-icon, {{WRAPPER}} .bdt-hover-video.skin-vertical .bdt-hover-wrapper-list .bdt-hover-mask-list .bdt-hover-mask .bdt-hover-icon'     => 'font-size: {{SIZE}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'selectors' => [ 
					'{{WRAPPER}} .bdt-hover-video.skin-default .bdt-hover-btn-wrapper .bdt-hover-btn .bdt-hover-icon' => 'font-size: {{SIZE}}{{UNIT}};',
			...
			<div <?php $this->print_render_attribute_string( 'hover_video_wrapper' ); ?>>
				...
				foreach ( $settings['hover_video_list'] as $index => $item ) :
					...
					if ( ! empty( $video_source ) ) {
						...
						$video_poster =  $item['hover_video_poster']['url'];
					} else {
