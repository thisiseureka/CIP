...
class AdvancedHeading extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'type'      => Controls_Manager::SWITCHER,
				'prefix_class' => 'bdt-ep-ah-title-multi-color-',
		...
		$this->add_control(
			'sub_heading_icon',
			[
				'label'       => esc_html__( 'Sub Heading Icon', 'bdthemes-element-pack' ),
		...
		$this->start_controls_tab(
			'tab_style_advanced',
			[
				'label' => esc_html__('Split Text', 'bdthemes-element-pack'), 
				'condition' => [
					'split_main_heading' => 'yes',
					'split_text!'        => ''
				]
	...
	protected function render_sub_heading(){
		...
		if ($settings['sub_heading']) {
			...
			?>
			<div <?php $this->print_render_attribute_string('sub-title'); ?>>
				...
				<?php echo wp_kses_post($subh_style); ?>
			</div>
			<?php
		}
		return ob_get_clean();
