	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'selectors' => [ 
					'{{WRAPPER}} .bdt-video' => 'max-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[ 
				'label'   => __( 'Hide Play/Pause Button', 'bdthemes-element-pack' ) . BDTEP_NC,
				'type'    => Controls_Manager::SWITCHER,
				'prefix_class' => 'bdt-video-play-pause-',
		...
		$this->start_controls_section(
			...
			[ 
				'label' => __( 'Video Player', 'bdthemes-element-pack' ) . BDTEP_NC,
		...
		$this->add_group_control(
			...
			[
				'name' => 'video_player_background',
				'selector' => '{{WRAPPER}}.elementor-widget-bdt-video-player .jp-video',
			]
		);
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => 'video_player_border',
				'selector' => '{{WRAPPER}}.elementor-widget-bdt-video-player .jp-video',
			]
		);
		$this->add_responsive_control(
			...
			[ 
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [ 
					'{{WRAPPER}}.elementor-widget-bdt-video-player .jp-video' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			'section_style_video_play_button',
			[ 
				'label' => __( 'Video Play Button', 'bdthemes-element-pack' ) . BDTEP_NC,
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->start_controls_tabs( 'tabs_video_play_button' );
		$this->start_controls_tab(
			'tab_video_play_button_normal',
			[ 
				'label' => __( 'Normal', 'bdthemes-element-pack' ),
			]
		);
		$this->add_control(
			'video_play_button_icon_color',
			[ 
		...
		$this->start_controls_tab(
			'tab_video_play_button_hover',
			[ 
				'label' => __( 'Hover', 'bdthemes-element-pack' ),
			]
		);
		$this->add_control(
			'video_play_button_hover_icon_color',
			[ 
				'label'     => __( 'Icon Color', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
		...
		$this->add_control(
			'video_play_button_hover_border_color',
			[ 
		...
		$this->add_control(
			'video_play_button_hover_pulse_color',
			[ 
				'label'     => __( 'Pulse Color', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
		...
		$this->start_controls_section(
			...
			[ 
				'label' => __( 'Control Area', 'bdthemes-element-pack' ) . BDTEP_UC,
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'play_button_size',
			[ 
				'label'     => esc_html__( 'Button Size (Deprecated)', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [ 
					'px' => [ 
						'min' => 30,
