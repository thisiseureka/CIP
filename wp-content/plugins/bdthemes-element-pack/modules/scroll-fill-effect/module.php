...
class Module extends Element_Pack_Module_Base {
	...
	public function register_controls( $widget, $args ) {
		...
		$widget->add_group_control(
			...
			[ 
				...
				'selector'       => '{{WRAPPER}} .elementor-heading-title, {{WRAPPER}} .bdt-heading-tag span, {{WRAPPER}} .bdt-ep-advanced-heading-main-title-inner',
			]
		);
	}
	...
	public function enqueue_scripts() {
		...
		wp_register_script( 'scroll-trigger', BDTEP_ASSETS_URL . 'vendor/js/ScrollTrigger.min.js', [], '3.12.5', true );
