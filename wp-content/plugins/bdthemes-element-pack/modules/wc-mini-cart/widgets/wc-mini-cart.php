...
class WC_Mini_Cart extends Module_Base {
	...
	public function get_keywords() {
		return ['mini cart', 'cart', 'wc', 'woocommerce', 'add to cart', 'wc cart', 'wc mini cart'];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label'   	=> esc_html__('Trigger on Cart Update', 'bdthemes-element-pack'),
				'type'    	=> Controls_Manager::SWITCHER,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-mini-cart-product-item .bdt-mini-cart-product-name,
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-mini-cart-product-item .bdt-mini-cart-product-name:hover,
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bdt-mini-cart-product-item .bdt-mini-cart-product-name,
				{{WRAPPER}} .bdt-mini-cart-product-item .bdt-mini-cart-product-name a',
			]
		);
		...
		$this->add_control(
			'empty_product',
			[
				'label' 	=> __('Empty Product Notice', 'bdthemes-element-pack'),
				'type' 		=> Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'#bdt-offcanvas-{{ID}}.bdt-offcanvas .bdt-offcanvas-close' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors' => [
					'#bdt-offcanvas-{{ID}}.bdt-offcanvas .bdt-offcanvas-close' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
