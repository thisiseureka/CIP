...
class Image_Expand extends Module_Base {
	...
	public function get_style_depends() {
		if ( $this->ep_is_edit_mode() ) {
			...
			return [ 'ep-font', 'ep-image-expand' ];
		}
	}
	...
	public function render_lightbox( $item ) {
		...
		$this->add_render_attribute( $key, 'class', 'bdt-ep-image-expand-lightbox' );	

		$this->add_render_attribute( $key, 'data-caption="' . htmlspecialchars( $item['image_expand_title'] ) . '"' );
		...
		<div class="bdt-ie-lightbox-wrap">
			<a <?php $this->print_render_attribute_string( $key ); ?>>
				...
				<?php elseif ( 'text' == $settings['link_type'] && $settings['link_text'] ) : ?>
					<span class="bdt-text">
						<?php esc_html_e( $settings['link_text'], 'bdthemes-element-pack' ); ?>
					</span>
				<?php endif; ?>
			</a>
		</div>
