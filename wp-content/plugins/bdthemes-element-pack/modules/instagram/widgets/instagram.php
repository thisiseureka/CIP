...
class Instagram extends Module_Base {
	...
	public function get_style_depends() {
		if ( $this->ep_is_edit_mode() ) {
			...
			return [ 'swiper', 'ep-font', 'ep-instagram' ];
		}
	}
	...
	public function render() {
		...
		?>
		<div <?php $this->print_render_attribute_string( 'instagram-wrapper' ); ?>>

			<div <?php $this->print_render_attribute_string( 'instagram' ); ?>>
						...
						<div
							...
							<div class="bdt-instagram-thumbnail">
								<?php if ( 'VIDEO' == $item->media_type ) : ?>
									<video src="<?php echo esc_url( $item->media_url ); ?>"
										title="Image by: <?php echo esc_html( $item->username ); ?>">
									<?php else : ?>
										<img src="<?php echo esc_url( $item->media_url ); ?>"
											alt="Image by: <?php echo esc_html( $item->username ); ?>" loading="lazy">
									<?php endif; ?>
							</div>
							...
							if ( $settings['show_lightbox'] or $settings['show_link'] ) :
								...
								?>
								<a target="<?php echo esc_attr( $target_blank ); ?>" href="<?php echo esc_url( $target_href ); ?>"
