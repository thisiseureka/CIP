...
class Notification extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[ 
				'label' => esc_html__( 'Referring URL', 'bdthemes-element-pack' ) . BDTEP_NC,
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[ 
				'label'       => esc_html__( 'Same Website', 'bdthemes-element-pack' ),
				'type'        => Controls_Manager::SWITCHER,
				'description' => esc_html__( 'If you will enable this feature, then your own host will behave like Referring URL.', 'bdthemes-element-pack' ),
			]
		);
		...
		$this->add_control(
			'ex_system',
			[ 
				'label' => esc_html__( 'External Website', 'bdthemes-element-pack' ),
				'type'  => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			'ex_system_url',
			[ 
				'label'     => esc_html__( 'External Website URL', 'bdthemes-element-pack' ),
	...
	public function render() {
		...
		$content  = isset( $settings['notification_content'] ) && ! empty( $settings['notification_content'] ) ? $this->parse_text_editor( $settings['notification_content'] ) : '';
		...
		?>
		<div <?php $this->print_render_attribute_string( 'notify_attr' ); ?>>
			<?php if (
				$settings['notification_type'] == 'fixed' &&
				$settings['notification_pos_fixed'] == 'relative'
			) : ?>
				<div id="bdt-notify-<?php echo esc_attr( $this->get_id() ); ?>" class="bdt-notify-wrapper
			...
			<?php if (
				...
				?>
				<div id="bdt-notify-<?php echo esc_attr( $this->get_id() ); ?>" class="bdt-notify-wrapper bdt-hidden bdt-alert-success bdt-alert <?php echo esc_attr( $fixed ); ?>
					bdt-position-<?php echo esc_attr( $settings['notification_pos_fixed'] ); ?>
