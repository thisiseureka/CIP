...
?>
        ...
        <div <?php $this->print_render_attribute_string('air-pollution'); ?>>
            ...
            <ul <?php $this->print_render_attribute_string('list'); ?>>
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    <div>
                        ...
                        bdt-ap-title">
                            <?php esc_html_e('Carbon monoxide', 'bdthemes-element-pack'); ?>
                ...
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    <div>
                        <<?php echo esc_attr($components_tag); ?> class="bdt-text-default bdt-text-bold bdt-margin-remove bdt-ap-title">
                            <?php esc_html_e('Nitrogen monoxide', 'bdthemes-element-pack'); ?>
                        </<?php echo esc_attr($components_tag); ?>>
                    </div>
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                ...
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    <div>
                        <<?php echo esc_attr($components_tag); ?> class="bdt-text-default bdt-text-bold bdt-margin-remove bdt-ap-title">
                            <?php esc_html_e('Nitrogen dioxide', 'bdthemes-element-pack'); ?>
                        </<?php echo esc_attr($components_tag); ?>>
                    </div>
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                ...
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    <div>
                        <<?php echo esc_attr($components_tag); ?> class="bdt-text-default bdt-text-bold bdt-margin-remove bdt-ap-title">
                            <?php esc_html_e('Ozone', 'bdthemes-element-pack'); ?>
                        </<?php echo esc_attr($components_tag); ?>>
                    </div>
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                ...
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    <div>
                        <<?php echo esc_attr($components_tag); ?> class="bdt-text-default bdt-text-bold bdt-margin-remove bdt-ap-title">
                            <?php esc_html_e('Sulphur dioxide', 'bdthemes-element-pack'); ?>
                        </<?php echo esc_attr($components_tag); ?>>
                    </div>
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                ...
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    <div>
                        <<?php echo esc_attr($components_tag); ?> class="bdt-text-default bdt-text-bold bdt-margin-remove bdt-ap-title">
                            <?php esc_html_e('Fine particles matter', 'bdthemes-element-pack'); ?>
                        </<?php echo esc_attr($components_tag); ?>>
                    </div>
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                ...
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    <div>
                        <<?php echo esc_attr($components_tag); ?> class="bdt-text-default bdt-text-bold bdt-margin-remove bdt-ap-title">
                            <?php esc_html_e('Coarse particulate matter', 'bdthemes-element-pack'); ?>
                        </<?php echo esc_attr($components_tag); ?>>
                    </div>
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                ...
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    <div>
                        <<?php echo esc_attr($components_tag); ?> class="bdt-text-default bdt-text-bold bdt-margin-remove bdt-ap-title">
                            <?php esc_html_e('Ammonia', 'bdthemes-element-pack'); ?>
                        </<?php echo esc_attr($components_tag); ?>>
                    </div>
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
