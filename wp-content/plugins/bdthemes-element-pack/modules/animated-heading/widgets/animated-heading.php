	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[ 
				...
				'selectors' => [ 
					...
					'{{WRAPPER}} .bdt-heading-layout-split_text .bdt-pre-heading *' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[ 
				...
				'label'    => esc_html__( 'Text Stroke', 'bdthemes-element-pack' ),
				'selector' => '{{WRAPPER}} .bdt-heading .bdt-pre-heading, {{WRAPPER}} .bdt-heading-layout-split_text .bdt-pre-heading *',
			]
		);
		...
		$this->add_control(
			...
			[ 
				...
				'selectors' => [ 
					...
					'{{WRAPPER}} .bdt-heading-layout-split_text .bdt-post-heading *' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[ 
				...
				'label'    => esc_html__( 'Text Stroke', 'bdthemes-element-pack' ),
				'selector' => '{{WRAPPER}} .bdt-heading .bdt-post-heading, {{WRAPPER}} .bdt-heading-layout-split_text .bdt-post-heading *',
			]
		);
					...
					'animated-heading' => [ 
						'data-settings' => [ 
							wp_json_encode( [ 
								...
								'anim_repeat'           => ( isset( $settings['spilt_anim_repeat'] ) && 'yes' === $settings['spilt_anim_repeat'] ) ? true : false,
							] )
						]
					]
				]
