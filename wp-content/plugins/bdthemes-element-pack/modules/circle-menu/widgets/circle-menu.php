...
class Circle_Menu extends Module_Base {
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[ 
				'label'        => esc_html__( 'Custom Style', 'bdthemes-element-pack' ),
		...
		$this->start_controls_section(
			...
			[ 
				'label' => esc_html__( 'Circle Menu Settings', 'bdthemes-element-pack' ),
			]
		);
		...
		$this->add_control(
			...
			[ 
				...
				'selectors' => [ 
					...
					'{{WRAPPER}} .bdt-circle-menu li.bdt-toggle-icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[ 
				...
				'selectors' => [ 
					...
					'{{WRAPPER}} .bdt-circle-menu li.bdt-toggle-icon:hover svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		foreach ( $settings['circle_menu'] as $index => $list ) :
			...
			if ( isset( $settings['tooltip_on_trigger'] ) && $settings['tooltip_on_trigger'] == 'yes' ) {
				$this->add_render_attribute(
					[ 
						$link_key => [ 
							'class'              => 'bdt-tippy-tooltip bdt-flex bdt-flex-middle bdt-flex-center',
							'data-tippy'         => '',
	...
	protected function render() {
			...
			$this->add_render_attribute(
				[ 
					'toggle-icon' => [ 
						...
						'class' => [ 
							'bdt-icon bdt-link-reset bdt-flex bdt-flex-center bdt-flex-middle',
							'bdt-position-center',
						],
					],
				]
				...
				[ 
					'toggle-icon' => [ 
						...
						'class' => [ 
							...
							'bdt-position-center bdt-flex bdt-flex-center bdt-flex-middle',
						],
					],
				]
			);
		...
		<div <?php $this->print_render_attribute_string( 'circle-menu-container' ); ?>>
			<ul class="bdt-circle-menu" <?php $this->print_render_attribute_string( 'circle-menu-settings' ); ?>>
