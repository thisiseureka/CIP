...
class Advanced_Progress_Bar extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'animation_delay',
			[ 
				'label'     => esc_html__( 'Animation Delay (s)', 'bdthemes-element-pack' ) . BDTEP_NC,
				'type'      => Controls_Manager::SLIDER,
				'range'     => [ 
					'px' => [ 
						'min' => 0.1,
					...
					<div class="bdt-ep-advanced-progress-bar-item elementor-repeater-item-<?php echo esc_attr( $progress['_id'] ); ?>">
						...
						<div class="bdt-ep-advanced-progress-bar-level">
							<div class="bdt-ep-advanced-progress-bar-fill "
								...
								data-width="<?php echo esc_attr( $progress['level']['size'] ) ?>%" data-animation-delay="<?php echo esc_attr( $settings['animation_delay']['size'] > 0 ? $settings['animation_delay']['size'] * $index : 0 ); ?>">
