...
class Facebook_Feed_Carousel extends Module_Base {
	...
	public function get_style_depends() {
		if ( $this->ep_is_edit_mode() ) {
			...
			return [ 'swiper', 'ep-font', 'ep-facebook-feed-carousel' ];
		}
	}
	...
	public function get_script_depends() {
		if ( $this->ep_is_edit_mode() ) {
			...
			return [ 'swiper', 'ep-facebook-feed-carousel' ];
		}
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'type'      => Controls_Manager::SLIDER,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-facebook-feed-carousel .bdt-img-wrap' => 'gap: {{SIZE}}{{UNIT}};',
				],
				'condition' => [ 
					'show_image_album' => 'yes'
				],
		...
		$this->add_control(
			...
			[ 
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-facebook-feed-carousel .bdt-album-img-count' => 'color: {{VALUE}};',
				],
				'condition' => [ 
					'show_image_album' => 'yes'
				],
		...
		$this->add_control(
			...
			[ 
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-facebook-feed-carousel .bdt-album-img-count' => 'background-color: {{VALUE}};',
				],
				'condition' => [ 
					'show_image_album' => 'yes'
				],
		...
		$this->add_group_control(
			...
			[ 
				...
				'selector' => '{{WRAPPER}} .bdt-facebook-feed-carousel .bdt-album-img-count',
				'condition' => [ 
					'show_image_album' => 'yes'
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-facebook-feed-carousel .bdt-dropdown' => 'min-width: {{SIZE}}{{UNIT}} !important; max-width: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);
