...
class Advanced_Divider extends Module_Base {
	...
	public function render_svg_image() {
		...
		?>
		<img src="<?php echo esc_url( $image_html ); ?>" alt="<?php echo esc_html( get_the_title() ); ?>" <?php $this->print_render_attribute_string( 'svg_image' ); ?>>
	...
	protected function render() {
		...
		<div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
			...
			<?php if ( 'select' == $settings['advanced_divider_type'] ) : ?>
				<img src="<?php echo esc_url( $svg_image ); ?>" alt="advanced divider" <?php $this->print_render_attribute_string( 'svg_image' ); ?>>
