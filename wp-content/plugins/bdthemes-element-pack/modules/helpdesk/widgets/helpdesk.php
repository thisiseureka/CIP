...
class Helpdesk extends Module_Base {
	...
	protected function render() {
		...
		<div class="bdt-helpdesk">
			<nav class="bdt-helpdesk-icons">
				...
				<label class="bdt-helpdesk-icons-open-button" for="<?php echo esc_attr( $id ); ?>"
					title="<?php echo esc_html( $settings['helpdesk_title'] ); ?>">
	...
	protected function messenger() {
		...
		$this->add_render_attribute( 'messenger', 'data-tippy-content', htmlspecialchars( $settings['messenger_title'], ENT_QUOTES, 'UTF-8' ) );
		...
		<a <?php $this->print_render_attribute_string( 'messenger' ); ?>>
	...
	protected function skype() {
		...
		$this->add_render_attribute( 'skype', 'data-tippy-content', htmlspecialchars( $settings['skype_title'], ENT_QUOTES, 'UTF-8' ) );
		...
		<a <?php $this->print_render_attribute_string( 'skype' ); ?>>
	...
	protected function viber() {
		...
		$this->add_render_attribute( 'viber', 'data-tippy-content', htmlspecialchars( $settings['viber_title'], ENT_QUOTES, 'UTF-8' ) );
		...
		<a <?php $this->print_render_attribute_string( 'viber' ); ?>>
	...
	protected function whatsapp() {
		...
		$this->add_render_attribute( 'whatsapp', 'data-tippy-content', htmlspecialchars( $settings['whatsapp_title'], ENT_QUOTES, 'UTF-8' ) );
	...
	protected function telegram() {
		...
		$this->add_render_attribute( 'telegram', 'data-tippy-content', htmlspecialchars( $settings['telegram_title'], ENT_QUOTES, 'UTF-8' ), );
		...
		<a <?php $this->print_render_attribute_string( 'telegram' ); ?>>
	...
	protected function custom() {
		...
		$this->add_render_attribute( 'custom', 'data-tippy-content', htmlspecialchars( $settings['custom_title'], ENT_QUOTES, 'UTF-8' ) );
		...
		<a <?php $this->print_render_attribute_string( 'custom' ); ?>>
	...
	protected function mailto() {
		...
		$this->add_render_attribute( 'mailto', 'data-tippy-content', htmlspecialchars( $settings['mailto_title'], ENT_QUOTES, 'UTF-8' ) );
		...
		<a <?php $this->print_render_attribute_string( 'mailto' ); ?>>
