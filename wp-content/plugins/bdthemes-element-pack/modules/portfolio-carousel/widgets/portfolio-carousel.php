...
class Portfolio_Carousel extends Module_Base {
    ...
    public function get_style_depends() {
        if ($this->ep_is_edit_mode()) {
            ...
            return ['swiper', 'ep-font', 'ep-portfolio-carousel'];
        }
    }
    ...
    public function get_script_depends() {
        if ($this->ep_is_edit_mode()) {
            ...
            return ['swiper', 'imagesloaded', 'ep-portfolio-carousel'];
        }
    }
                        ...
                        <div class="bdt-flex-inline bdt-gallery-item-link-wrapper">
                            <?php if (('lightbox' == $settings['show_link']) || ('both' == $settings['show_link'])) : ?>
                                <a <?php $this->print_render_attribute_string('lightbox-settings'); ?>>
                                    ...
                                    <?php elseif ( 'text' == $settings['link_type'] && $settings['lightbox_link_text'] ) : ?>
                                        <span><?php esc_html_e( $settings['lightbox_link_text'], 'bdthemes-element-pack' ); ?></span>
                                    <?php endif; ?>
                                </a>
                            <?php endif; ?>
                            ...
                            <?php if (('post' == $settings['show_link']) || ('both' == $settings['show_link'])) : ?>
                                ...
                                <?php elseif ( 'text' == $settings['link_type'] && $settings['post_link_text'] ) : ?>
                                    <span><?php esc_html_e( $settings['post_link_text'], 'bdthemes-element-pack' ); ?></span>
                                <?php endif; ?>
                                </a>
                            <?php endif; ?>
                        </div>
