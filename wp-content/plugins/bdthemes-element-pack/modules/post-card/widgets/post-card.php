	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-post-card-item' => 'background-color: {{SIZE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'shadow_width',
			[
				'label'      => esc_html__('Highlighted Border Width', 'bdthemes-element-pack'),
				'type'       => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min'  => 0,
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-post-card .bdt-subnav span:after' => 'background: {{VALUE}}',
				],
			]
		);
