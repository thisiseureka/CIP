<?php
/**
 * The 'Rsssl_Ip_Blocked_Permanent' class is a part of the 'Really Simple Security pro' plugin,
 * which is developed by the company 'Really Simple Plugins'.
 * This class is responsible for handling the Rsssl_Ip_Blocked_Permanent event
 *
 ...
 * which is developed by the company 'Really Simple Plugins'.
 * This class is responsible for handling the Rsssl_Ip_Blocked_Permanent event
 * with the event code of 2030.
 *
 * @package     RSSSL\Pro\Security\Wordpress\Eventlog\Events  // The categorization of this class.
 */
class Rsssl_Ip_Blocked_Permanent extends Rsssl_Event_Log_Handler {
	/**
	 * Class constructor.
	 *
