<?php
/**
 * The 'Rsssl_Ip_Removed_From_Blocklist' class is a part of the 'Really Simple Security pro' plugin,
 * which is developed by the company 'Really Simple Plugins'.
 * This class is responsible for handling the Rsssl_Ip_Removed_From_Blocklist event
 *
 ...
 * which is developed by the company 'Really Simple Plugins'.
 * This class is responsible for handling the Rsssl_Ip_Removed_From_Blocklist event
 * with the event code of 2031.
 *
 * @package     RSSSL\Pro\Security\Wordpress\Eventlog\Events  // The categorization of this class.
 */
class Rsssl_Ip_Removed_From_Blocklist extends Rsssl_Event_Log_Handler {
	/**
	 * Class constructor.
	 *
